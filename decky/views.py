...
from .models import Kontak, Produk, Kategori, Profil, Slide, Statis,ChatID
from kurniawanp.models import Transaksi, DetailTransaksi
...
from kurniawanp.forms import CartAddProductForm
from kurniawanp.keranjang import Cart
import datetime
...
#         "categories": kategori
#     }
#     return render(request, 'shop4.html', context)
...
class CheckoutView(View):
    ...
    def post(self, request):
        ...
        if context['has_error']:
                return render(request, 'coba.html', context, status=400)
